...
public class ProductConfig {
    ...
    CommandLineRunner commandLineRunner(IProductRepository productRepository) {
        ...
        newWatches.add(new Watch(UUID.randomUUID(), "Rolex Submariner", "Rolex Submariner", 12913.00, generalInfo,
                housingInfo,
                features, 25, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(), "Rolex GMT Master II", "Rolex GMT Master II", 15889.00,
                generalInfo,
                housingInfo, features, 6, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(),"Rolex Daytona", "Rolex Daytona", 14800.00, generalInfo,
                housingInfo, features,
                2, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(),"Rolex Explorer", "Rolex Explorer", 8499.00, generalInfo,
                housingInfo, features
                , 3, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(),"Rolex Yacht-Master", "Rolex Yacht-Master", 9885.00, generalInfo,
                null, null, 7, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(),"Rolex Datejust", "Rolex Datejust", 7280.00, generalInfo,
                housingInfo, features
                , 0, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(),"Rolex Sea-Dweller", "Rolex Sea-Dweller", 14150.00, generalInfo,
                housingInfo
                , features, 14, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(),"Rolex Milgauss", "Rolex Milgauss", 10600.00, generalInfo,
                housingInfo, features
                , 35, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(),"Rolex Sky-Dweller", "Rolex Sky-Dweller", 49936.00, generalInfo,
                housingInfo
                , features, 1, 0, null, "Rolex"));
        newWatches.add(new Watch(UUID.randomUUID(),"Rolex Cellini", "Rolex Cellini", 3722.00, generalInfo,
                housingInfo, features,
                9, 0, null, "Rolex"));
